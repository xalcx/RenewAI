...
const translations = {
  es: {
    ...
    windTurbineDamageReport: "Informe de Detección de Daños en Turbinas Eólicas",
    analysisSummary: "Resumen del Análisis",
    detectionModel: "Modelo de detección",
    page: "página",
    of: "de",
    reportGenerated: "Informe generado",
    reportDownloadedSuccessfully: "El informe se ha descargado correctamente",
  ...
  en: {
    ...
    windTurbineDamageReport: "Wind Turbine Damage Detection Report",
